...
const ProfileForm = ({profile:{profile, loading}, createProfile, getCurrentProfile, history}) => {
  ...
  const creatingProfile = useRouteMatch('/create_profile');
  ...
  useEffect(() => {
    ...
    // this is to set the previous data in form during edit option 
    if (!loading && profile) {
          ...
          <form className="form" onSubmit={onSubmit}>
            ...
            <div className="my-2">
              <button
                ...
                type="button"
                className="btn btn-light boundary"
              >
